...
export async function GET() {
  ...
  const manifest = {
    ...
    frame: {
      ...
      tags: ["snake", "game", "arcade", "retro", "base"],
      tagline: "The classic snake game, on Base",
      ogTitle: "Snake — Retro Classic",
      ogDescription: "Classic retro snake game on Base. Eat apples, dodge obstacles, save your score on-chain.",
